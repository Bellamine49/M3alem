...
<div class="min-h-[60vh] flex items-center justify-center px-4">
    <div class="text-center">
        <div class="text-8xl font-bold text-gray-200 dark:text-gray-700 mb-4">500</div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Something went wrong</h1>
        <p class="text-gray-500 dark:text-gray-400 mb-8">We're experiencing technical difficulties. Please try again later.</p>
