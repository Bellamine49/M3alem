...
@section('meta_description', 'Learn about ServiceMarket - connecting homeowners with trusted local professionals.')

@section('content')
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">About ServiceMarket</h1>
    ...
    <div class="prose dark:prose-invert max-w-none">
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-gray-700 mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-300 leading-relaxed">ServiceMarket was founded with a simple goal: make it easy to find reliable, skilled professionals for your home service needs. We believe everyone deserves access to quality work at fair prices.</p>
        </div>
        ...
        <div class="bg-gradient-to-br from-brand-600 to-purple-600 rounded-2xl p-8 text-white text-center">
            ...
            <p class="text-blue-100 mb-6">Whether you're looking for help or offering your skills, ServiceMarket is for you.</p>
